# Web Development Project 3 - *Dog Breed Flashcards*

Submitted by: **Allison Lee**

This web app: **Gives user a chance to test their knowledge on various dog breeds by flipping through flashcards, looking at the descriptions of their key identifying traits, and guessing the corresponding dog breed.**
...
* [X] List anything else that you added to improve the site's functionality!
  - Indicated which number card the user is on out of the total number of cards available
...
>>>>>>> parent of b0d0971 (Update README.md)
